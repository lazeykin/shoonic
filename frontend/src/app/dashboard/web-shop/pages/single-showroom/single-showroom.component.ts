...
@Component({
  selector: 'app-single-showroom',
  templateUrl: './single-showroom.component.html',
  styleUrls: ['./single-showroom.component.sass']
})
export class SingleShowroomComponent implements OnInit {
  scope: string;
  shop: string;
  webSiteInfo: any = {};
  personalInfo: any = {};
