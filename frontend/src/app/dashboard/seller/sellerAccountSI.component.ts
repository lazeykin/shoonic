...
// @Component({
//     templateUrl: 'sellerAccountSI.component.html',
//     styleUrls: ['sellerAccountSI.component.sass']
// })

// export class SellerAccountSIComponent implements OnInit {
...
//         phone_number: new FormControl('', [<any>Validators.maxLength(80), <any>Validators.required]),
...
//             this.sales = response;
//         });
//         this.productsService.productChoises(this.userService.getCurrentUserToken())
//             .subscribe(
//                 data => {
